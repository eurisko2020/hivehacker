...
nice -n -10 ionice -c 1 -n 0 -t ./libcamera-bridge --config camera_bridge_config.json --config-override /mnt/data/camera_bridge_config.json --segment 0  --timeout 0 --tuning-file imx477.json
